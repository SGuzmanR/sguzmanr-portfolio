    ...
    <section id="services" className="w-full h-auto">
      <div className="w-full paddingX flex flex-row max-sm:flex-col justify-between items-center gap-5">
        <div className="w-full mt-16 flex flex-col">
          <h2 className="services-title text-[8vw] max-sm:text-[12vw] font-extrabold">SERVICIOS</h2>
          <p className="services-subtitle text-wrap text-[2vw] max-sm:text-[6vw]">
        ...
        <div className="services-btn w-full flex items-center justify-end">
          <Link href="#contact" className="flex flex-row gap-5 bg-white text-black py-3 px-5 rounded-xl text-xl hover:text-white hover:bg-black transition-colors duration-500 fill-black hover:fill-white">
