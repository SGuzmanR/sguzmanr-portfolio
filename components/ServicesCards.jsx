...
const ServicesCards = () => {
  ...
  return (
    <div className="service-card_wrapper flex flex-row w-full h-full justify-between items-center paddingX">
      <div className="grid grid-cols-4 grid-rows-1 w-full h-screen py-48 max-sm:py-24 justify-center items-end gap-6 max-[1300px]:grid-cols-2 max-[1300px]:grid-rows-2 max-sm:grid-cols-1 max-sm:grid-rows-4 max-sm:gap-0">
        {services.map((service, i) => (
          ...
          >
            <div className="service-card flex flex-col justify-between h-full w-full p-6">
              <div className="services-card_item1 flex flex-row gap-6 -translate-x-20 items-center">
                ...
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 600 600"
                  className="h-full w-12 service-card_icon"
                  fill="#353535"
                >
                  {service.icon}
                </svg>
              ...
              <div className="services-card_item2 flex flex-col gap-2">
                <h3 ref={titleRef} className="font-bold text-2xl">{service.title}</h3>
