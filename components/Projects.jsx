...
const Slider = () => {
  ...
  return (
    <section id='portfolio' className='w-full h-auto'>
      <div className='portfolio-intro relative w-full h-[10vw] bg-white'>
        <div className='absolute portfolio-bg bg-radial-black w-full h-full flex items-center justify-center z-20'>
          <h2 className='font-montserrat font-bold text-[8vw] text-white'>PORTAFOLIO</h2>
        </div>
      </div>

      <div id='slide' className='relative bg-white'>
